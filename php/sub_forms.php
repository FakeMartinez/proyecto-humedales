...
if(isset($_POST['nombre_cuenca'])) {
//  $add_id = $_POST['id_cuenca'];
  $add_nom = $_POST['nombre_cuenca'];
  $add_sup = $_POST['sup_cuenca'];
  $add_tipo = $_POST['tipo_cuenca'];
   
  $query1 = "INSERT into cuenca (Nombre_cuenca, Superficie, Tipo_cuenca) VALUES ('$add_nom','$add_sup','$add_tipo')";
  act($connect,$query1);
...
if(isset($_POST['nombre_complejo'])) {
//  $add_id = $_POST['id_complejo'];
  $add_nom = $_POST['nombre_complejo'];
  $add_prop = $_POST['prop_complejo'];

  
  $query2 = "INSERT into complejo (Nombre_complejo) VALUES ('$add_nom')";
...
if(isset($_POST['id_propie'])) {
  ...
  $query2 = "INSERT into persona (Id_persona, Nombre_persona, Correo, Teléfono, Dirección) VALUES ('$add_id','$add_nom','$add_correo','$add_tel','$add_dire')";
...
//    $add_ID = $_POST['ID_presion'];
    $query3 = "INSERT into presiones (Tipo_presiones, Observacion) VALUES ('$add_tipo','$add_obs')";  //crea la insercion en SQL de la nueva informacion en la tabla presiones
...
//    $add_ID = $_POST['id_fauna'];
    ...
    $query4 = "INSERT into fauna (Nombre_coloquial, Nombre_científico, Descripción) VALUES 
    ('$add_nomcq','$add_nomci','$add_carac')";

    act($connect,$query4);

    $query4_1 = "SELECT Id_fauna FROM fauna WHERE Nombre_coloquial = '$add_nomcq' and Nombre_científico = '$add_nomci'"; // and NombreCientífico = '$add_nomci'
...
//    $add_ID= $_POST['id_flora'];
    ...
    $query5 = "INSERT into flora (Nombre_coloquial, Nombre_científico, Descripcion) VALUES ('$add_nomcq','$add_nomci','$add_carac')"; // inserte flora
    act($connect,$query5);

    $query5_1 = "SELECT Id_flora FROM flora WHERE Nombre_coloquial = '$add_nomcq' and Nombre_científico = '$add_nomci'";
